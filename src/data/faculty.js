export const facultyObject = [
  {
    ...
    desc: {
      ...
      4: "Beyond his role as a guitar teacher, Mr. Ravi Kumar has made significant contributions to the music education community. As a board member of Musical International USA and in association with Rockschool London, he has played a key role in promoting global standards of music education. His certification as a CBSE music teacher and experience with leading educational institutions reflect his commitment to excellence in teaching. Mr. Kumar's dedication to empowering students through music has left an indelible mark on the educational landscape, inspiring countless individuals to pursue their passion for music.",
    },
  },
  {
    id: 2,
    ...
    desc: {
      1: "Mr. Rahul Kumar is a remarkable drummer and a versatile musician, bringing a unique blend of talent and creativity to his role as the Drum Faculty at Rhythmicstan. With a passion for rhythm that spans years, Mr. Kumar has honed his craft to become a phenomenal drummer and an accomplished musician. His journey in music has been marked by innovation and originality, with viral songs and original compositions that showcase his exceptional talent and creativity.",
      2: "As a drummer, Mr. Rahul Kumar is known for his technical proficiency and dynamic style. His mastery of rhythm extends beyond the drum kit, allowing him to explore diverse musical genres and styles with ease. In addition to his skill as a drummer, Mr. Kumar is also a talented music composer, with a knack for crafting captivating melodies and arrangements that resonate with audiences.",
      3: "Mr. Rahul Kumar believes in inspiring students to discover their own unique voice and expression through music. His teaching philosophy is rooted in creativity, encouraging students to explore their musical instincts and push the boundaries of their artistry. With a focus on innovation and self-expression, Mr. Kumar empowers students to develop their skills as drummers and musicians while nurturing their passion for rhythm and creativity.",
      4: "Throughout his career, Mr. Rahul Kumar has achieved notable success as both a performer and a composer. His viral songs and original compositions have garnered widespread acclaim, earning him recognition as a rising star in the music industry. As a teacher, Mr. Kumar's passion for music and commitment to excellence inspire students to reach new heights in their musical journey. His contributions to the music community extend beyond the classroom, as he continues to push the boundaries of creativity and innovation in his own music and inspire others to do the same.",
    },
  },
  {
    id: 3,
    ...
    desc: {
      1: "Mr. Praveen Solanki brings a wealth of passion and talent to his role as a Keyboard/Piano instructor at Rhythmicstan. With over 5 years of teaching experience and a Grade 5 certification in electronic keyboard (classical and jazz), Mr. Solanki's journey in music began at the age of 10. His dedication to music education is evident in his multifaceted expertise, which extends beyond keyboard and piano to include harmonium and vocal instruction.",
      2: "He specializes in keyboard, piano, harmonium, and vocal instruction, offering students a comprehensive foundation in musical expression. His proficiency in classical and jazz keyboard techniques enables students to explore a diverse range of musical genres and styles under his guidance. Additionally, his vocal expertise enhances his teaching approach, allowing students to develop a holistic understanding of musical performance.",
      3: "He is a firm believer in the importance of building strong fundamentals in music education. He emphasizes the significance of mastering basic principles and techniques as the cornerstone for students' musical growth and development. Through patient and structured instruction, Mr. Solanki empowers students to cultivate a solid foundation in music theory, technique, and performance, setting them on the path to musical excellence.",
      4: "Throughout his academic journey, he has garnered numerous accolades and awards for his musical talents. His dedication and commitment to music have been recognized through accolades earned during his school and college years, showcasing his exceptional musical abilities and contributions to the field. As a passionate educator and performer, he continues to inspire students to pursue their musical aspirations and unlock their full potential.",
    },
  },
  {
    id: 4,
    ...
    desc: {
      ...
      3: "As an educator, Mr. Sahil Salhotra believes in nurturing a deep appreciation for Indian vocal music while empowering students to discover and develop their unique voice. He emphasizes the importance of technique, expression, and musicality in vocal performance, providing students with a solid foundation to express themselves authentically through music. With a supportive and encouraging teaching style, Mr. Salhotra fosters a collaborative learning environment where students can explore their creativity and grow as confident and skilled vocalists.",
      4: "Throughout his illustrious career, Mr. Sahil Salhotra has achieved numerous accolades and contributed significantly to the music community. His completion of a Diploma in Hindustani Classical Vocals and ongoing pursuit of a Masters degree reflect his dedication to excellence in music education. Mr. Salhotra's performances for prestigious clients such as Mr. Piyush Bansal, CEO of Lenskart, and at esteemed venues like the President's House highlight his exceptional talent and professionalism. His ranking in the top 5 of the 'Ekta Mission Singing Sitaro ki Khoz' further underscores his musical prowess and dedication to his craft.",
    },
  },
  {
    id: 5,
    ...
    desc: {
      ...
      3: "Miss Angela believes in creating a supportive and nurturing environment where students feel empowered to explore and express themselves through music. Her teaching philosophy centers around the idea that everyone has a unique voice and story to share, and she strives to help each student discover and develop their own individual style and sound. With patience, encouragement, and personalized instruction, Miss Angela inspires her students to embrace their voice and reach their full potential as singers.",
      4: "IThroughout her career, Miss Angela has made significant contributions to the music community as both a performer and a teacher. Her amazing and soothing voice has captivated audiences and earned her widespread acclaim, while her dedication to teaching has empowered countless students to discover the joy of singing. Miss Angela's passion for music and her commitment to excellence continue to inspire others to pursue their musical dreams and find their voice.",
    },
  },
  {
    id: 6,
  ...
  },
  {
    ...
    desc: {
      ...
      3: "Mr. Tushar believes in creating a supportive and inclusive learning environment where students feel inspired to explore and express themselves through percussion. His teaching philosophy emphasizes the importance of rhythm, timing, and musicality in percussion performance. With hands-on instruction and interactive learning experiences, Mr. Tushar guides students on a journey of discovery and creativity, helping them develop their skills and confidence as percussionists.",
